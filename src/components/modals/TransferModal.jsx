...
import { nft_transfer_refundable_fees } from '../../utils/user_nft';
import numeral from 'numeral';

const TransferModal = ({ formSubmit, setTransferModal, setAnyModalOpen, NFTImage, NFTName, NFTCollectionName, NFTCollectionContract, CollectionVerification, collectionTrading, actionLoad, NFTImagesBaseURI, NFTImageToReplaceURIs, setRecieverAddress }) => {
                    ...
                    <div className="modal-header">
                        ...
                        {!actionLoad && (
                            <button
                                ...
                                aria-label="Close"
                                onClick={() => (
                                    setTransferModal(false), setAnyModalOpen(false)
                                )}
                            >
                                <svg
                                    ...
                                    <div className="flex flex-wrap items-center mt-2">
                                        <span className="dark:text-jacarta-300 text-jacarta-500 mr-1 text-sm flex">
                                            ...
                                            <span className="flex align-middle justify-center">
                                                ...
                                                />
                                                {nft_transfer_refundable_fees / 1000000000}
                                            </span>
                                        </span>
                            ...
                            <div className="ml-auto">
                                <span className="flex items-center whitespace-nowrap">
                                    ...
                                    <span className="text-green font-medium tracking-tight">
                                        {parseFloat(nft_transfer_refundable_fees / 1000000000)}
                                    </span>
                                </span>
                            </div>
                        </div>
