...
const MobileNavbar = () => {
    ...
    return (
        <nav class="navbar w-full bg-white dark:bg-jacarta-800 p-6 mt-[-20px] lg:hidden">
            {/* mobile search  */}
            <form action="search" class="relative mb-8 w-full">
                <input type="search"
            ...
            <ul class="flex flex-col lg:flex-row">
                <li className="group relative">
                    ...
                    >
                        ...
                        <i class="lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                                class="h-4 w-4 fill-jacarta-700 dark:fill-jacarta-200">
                                <path fill="none" d="M0 0h24v24H0z" />
