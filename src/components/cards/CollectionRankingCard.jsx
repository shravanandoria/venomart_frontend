...
const CollectionRankingCard = ({ id, contractAddress, Logo, Name, Volume, isVerified, Floor, Owners, Items }) => {
    return (
        <Link href={`/collection/${contractAddress}`} className="flex transition-shadow hover:shadow-lg" role="row">
            ...
            >
                ...
                <div className="relative mr-2 w-8 shrink-0 self-start lg:mr-5 lg:w-12">
                    <Image src={Logo.replace("ipfs://", "https://ipfs.io/ipfs/")} height={100} width={100} alt="collectionlogo" className="rounded-2lg" loading="lazy" />
                    {isVerified ?
            ...
            <div
                ...
                role="cell"
            >
                <span className="dark:text-jacarta-200 text-jacarta-700">5 %</span>
            </div>
            ...
            <div
                ...
                role="cell"
            >
                <span className='dark:text-jacarta-200 text-jacarta-700'>{Items}</span>
            </div>
        </Link>
    )
}
