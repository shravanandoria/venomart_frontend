                        ...
                        <div className="mx-auto max-w-[48.125rem]">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className={`dropdown my-1 cursor-pointer w-[100%] ${theme == "dark" ? "dark:bg-jacarta-900 dark:text-white" : "bg-white text-black"}`}
                                    required
                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1">
                                                            <input
                                                                ...
                                                                name="type"
                                                                type="text"
                                                                className={`h-12 w-full border border-jacarta-100 focus:ring-inset focus:ring-accent ${theme == "dark" ? "border-jacarta-600 bg-jacarta-700 text-white placeholder:text-jacarta-300" : "w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent border-jacarta-900 bg-white text-black placeholder:text-jacarta-900"}`}
                                                                placeholder="Type"
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="flex-1">
                                                            <input
                                                                ...
                                                                name="value"
                                                                type="text"
                                                                className={`h-12 w-full rounded-r-lg border border-jacarta-100 focus:ring-inset focus:ring-accent ${theme == "dark" ? "border-jacarta-600 bg-jacarta-700 text-white placeholder:text-jacarta-300" : "w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent border-jacarta-900 bg-white text-black placeholder:text-jacarta-900"}`}
                                                                placeholder="Value"
                                                            />
                                                        </div>
                                                    </div>
