...
const Rankings = ({ theme }) => {
    return (
        <section className={`${theme}`}>
            <div class={`relative py-24 dark:bg-jacarta-800`}>
                <div class="container">
                    <h1 class="py-16 text-center font-display text-4xl font-medium text-jacarta-700 dark:text-white">Rankings</h1>
                    ...
                    <div class="scrollbar-custom overflow-x-auto">
                        <div class="w-full min-w-[736px] border border-jacarta-100 bg-white text-sm dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white lg:rounded-2lg">
