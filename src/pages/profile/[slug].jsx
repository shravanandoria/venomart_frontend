                ...
                <div className="container">
                    <div className="text-center">
                        ...
                        <p className="mx-auto max-w-xl text-lg dark:text-jacarta-300 mb-6">
                            {user_data?.bio}
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam officiis similique pariatur recusandae eos labore excepturi, culpa qui. Hic obcaecati, quas non delectus nihil fugiat voluptatem ratione ipsa ea atque alias laborum odit facere! Corporis architecto beatae cupiditate hic in sequi temporibus id aperiam deserunt.
                        </p>
