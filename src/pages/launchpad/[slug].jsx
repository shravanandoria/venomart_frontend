...
import Head from "next/head";
import Loader from "@/components/Loader";
>>>>>>> 1f440981b6b12a80df3ec5b9fc901a32158e723a

const Collection = ({ blockURL, theme, webURL, copyURL }) => {
              ...
              <div className="grid h-full items-center gap-4 md:grid-cols-12">
                ...
                <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
                  ...
                  <p className="mb-8 text-center text-lg dark:text-jacarta-200 md:text-left">
                    Punks is a hand drawn 1/1 PFP collection by muimooi. AxA is
                    the Alpha Gang in AVAX, Profile picture illustration. Supply
                    50 characters
                  </p>
                  {/* action  */}
                                ...
                                <div className="lg:w-4/5 mx-auto flex flex-wrap justify-between w[100%]">
                                    ...
                                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        ...
                                        <div className="flex items-center pb-5 border-b-2 border-gray-100 mb-5">
                                            ...
                                            {actionVerify ?
                                                <button className="w-[60%] flex justify-center ml-auto text-white bg-green-800 border-0 py-2 px-6 focus:outline-none rounded">Verified
                                                ...
                                                <div className="w-[100%]">
                                                    {comLoading ?
                                                        ...
                                                        :
                                                        <button onClick={verifyAction} className="flex w-[60%] justify-center ml-auto text-white bg-red border-0 py-2 px-6 focus:outline-none rounded">Verify Tasks</button>
                                                    }
                                                </div>
                                            }
                                        </div>
              ...
              <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap justify-between w[100%]">
                  ...
                  <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <h1 className=" text-[8px] text-jacarta-700 dark:text-white text-3xl title-font font-medium mb-1">
                      Tasks :
                    </h1>
                    <div className="flex mt-6 items-center pb-5 border-gray-100 ">
                      <p className=" text-center text-lg dark:text-jacarta-200 md:text-left">
                    ...
                    <div className="flex items-center pb-5 border-b-2 border-gray-100 mb-5">
                      ...
                      {actionVerify ? (
                        <button className="w-[60%] flex ml-auto text-white bg-green border-0 py-2 px-6 focus:outline-none rounded">
                          Verified
                        </button>
                      ) : (
                        <button
                          onClick={verifyAction}
                          className="w-[60%] flex ml-auto text-white bg-red border-0 py-2 px-6 focus:outline-none rounded"
                        >
                          Verify
                        </button>
                      )}
