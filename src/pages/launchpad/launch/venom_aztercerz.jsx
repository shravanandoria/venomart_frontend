...
const venom_aztercerz = ({
    ...
    // change from here
    const launchSlug = customLaunchpad.find(item => item.id === 9);
    // change till here
    ...
    const NFTARRAY = [
        {
            Image: "https://ipfs.io/ipfs/QmPK6dzocKpwL3LYRgPd9jLJGcym8Bbsxp2LoEJepPch3a/Mythic.jpg",
            properties: [
                { trait_type: "Rarity", value: "Mythic" }
            ]
        },
        {
            Image: "https://ipfs.io/ipfs/QmT7Zzr2ECMWCqHiv1BAa9PDzmj757NrNx8qX8iFZZbFXD/Epic.jpg",
            properties: [
                { trait_type: "Rarity", value: "Epic" }
            ]
        },
        {
            Image: "https://ipfs.io/ipfs/QmW1XtxSjbPKLuRjz1jVUCddPbMWLb3ukj4upgD5cKPypQ/Rare.jpg",
            properties: [
                { trait_type: "Rarity", value: "Rare" }
            ]
        },
        {
            Image: "https://ipfs.io/ipfs/QmU6LkuwQ3ULvkvaPBWXZJu1UajvSqJqQENXzhq3CCzvgY/Common.jpg",
            properties: [
    ...
    const getRandomTokenId = () => {
        ...
        let token_id_calcy = getRandomInt(5);
        let obj = {
            image: NFTARRAY[token_id_calcy]?.Image,
            collectionName: ProjectName,
            name: ProjectName,
            description: shortDesc,
            collectionAddress: contractAddress,
            mintPrice: parseFloat(mintPrice),
            properties: NFTARRAY[token_id_calcy]?.properties,
        }
        set_data(obj);
    }
...
export default venom_aztercerz;
