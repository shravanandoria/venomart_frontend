...
const dukes_sailorkim = ({
    ...
    // change from here
    const launchSlug = customLaunchpad.find(item => item.id === 22);
    // change till here
                                    ...
                                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        ...
                                        {projectTwitter &&
                                            <div className="flex mt-6 items-center pb-5 border-gray-100 ">
                                                <p className="text-left text-lg dark:text-jacarta-200 md:text-left mr-[7px]">
                                                    1] Follow Venom Dukes on twitter
                                                </p>
                                                <Link
                                        ...
                                        {projectDiscord &&
                                            <div className="flex items-center pb-5 mb-5">
                                                <p className="text-left text-[20px] dark:text-jacarta-200 md:text-left mr-[7px]">
                                                    4] Join Venom Dukes discord server
                                                </p>
                                                <Link
                                                    href={projectDiscord}
                                                    target="_blank"
...
export default dukes_sailorkim;
