    ...
    return (
        <div className={`${theme}`}>
            <Head>
                ...
                <meta
                    name="description"
                    content="Terms and conditions of venomart marketplace, 10 minutes read and understand the terms"
                />
            ...
            <section className="relative pt-48 pb-16 dark:bg-jacarta-800 md:pb-24">
                <div className="container">
                    ...
                    <div className="article-content mx-auto max-w-[48.125rem]">
                        ...
                        <p>
                            Venomart, (“venomart.io,” “we,” “our,” “us” and together with you, the “Parties”) provides its marketplace and services (described below) to you (“you” or “User'' and collectively with others using the Site “Users").
                        ...
                        <p>
                            Member Account, Password, and Security : You are responsible for the security of your account and your MetaMask wallet (and other Venom wallets and accounts)  and (b) ensure that you exit from your account at the end of each session when accessing Venomart. If you become aware of any unauthorized use of your password or account or any other breach of security, you agree to notify us immediately at venomart.io@gmail.com Venomart will not be liable for any loss or damage arising from your failure to comply with this Section.
                        </p>
                        ...
                        <p>F. To the fullest extent permitted by law and notwithstanding any other provision of this agreement or any other agreement contemplated herein or applicable provisions of law or equity or otherwise, the parties hereto hereby agree to eliminate any and all fiduciary duties the venomart.io may have to the user, its affiliates, or the end users of the app or its content, provided that such exclusion or limitation of liability shall not extend to venomart.io misappropriation of assets or funds of its users or its affiliates, or the end users of the app or content provided by venomart.io or other acts or omissions that constitute a bad faith violation of the implied contractual covenant of good faith and fair dealing.
                        </p>
